...
public class SimplifiedChinese extends Language {
    ...
    public SimplifiedChinese() {
        ...
        yml.addDefault(Messages.COMMAND_JOIN_DENIED_IS_FULL, "%bw_lang_prefix%&c该游戏已满！\n&a请考虑赞助以支持我们！ &7&o(点此查看)");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_DENIED_MSG, "&c该游戏不允许观战！");
        ...
        yml.addDefault(Messages.COMMAND_LEAVE_HAS_PARTY_POPUP_TITLE, "你确定吗？");
        yml.addDefault(Messages.COMMAND_LEAVE_HAS_PARTY_POPUP_STAY, "&c否");
        yml.addDefault(Messages.COMMAND_LEAVE_HAS_PARTY_POPUP_STAY_LORE, List.of("&f待在这场游戏"));
        yml.addDefault(Messages.COMMAND_LEAVE_HAS_PARTY_POPUP_BRING_PARTY, "&a确定");
        yml.addDefault(Messages.COMMAND_LEAVE_HAS_PARTY_POPUP_BRING_PARTY_LORE, List.of("&f队伍与你一同传送"));
        yml.addDefault(Messages.COMMAND_LEAVE_MSG, "%bw_lang_prefix%&7%bw_player%&e离开了游戏！");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_HELP, Arrays.asList("&6▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬",
                ...
                "&e/party invite <玩家> &7- &b邀请一位玩家到你的组队",
                "&e/party leave &7- &b离开当前组队",
                "&e/party info &7- &b列出组队队长及其队员",
                "&e/party promote <player> &7- &b转让组队",
                "&e/party remove <玩家> &7- &b将玩家移出组队",
                "&e/party accept <玩家> &7- &b接受组队邀请",
                "&e/party disband &7- &bD解散组队")
        );
        ...
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_SENT_TARGET_RECEIVE_MSG, "%bw_lang_prefix%&b%bw_player%&e邀请你加入组队！ &o&7(点此接受)");
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_CANNOT_INVITE_YOURSELF, "%bw_lang_prefix%&c你不可以邀请你自己！");
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "%bw_lang_prefix%&7%bw_player%&e不在线！");
        yml.addDefault(Messages.COMMAND_PARTY_ACCEPT_DENIED_NO_INVITE, "%bw_lang_prefix%&c没有可以接受的组队邀请！");
        yml.addDefault(Messages.COMMAND_PARTY_ACCEPT_DENIED_ALREADY_IN_PARTY, "%bw_lang_prefix%&e你已经在组队中了！");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_ACCEPT_SUCCESS, "%bw_lang_prefix%&7%bw_player%&e加入了组队！");
        yml.addDefault(Messages.COMMAND_PARTY_GENERAL_DENIED_NOT_IN_PARTY, "%bw_lang_prefix%&c你不在组队中！");
        yml.addDefault(Messages.COMMAND_PARTY_LEAVE_DENIED_IS_OWNER_NEEDS_DISBAND, "%bw_lang_prefix%&c你不可以离开由你带领的组队！\n&e使用：&b/party disband &e来解散组队。");
        yml.addDefault(Messages.COMMAND_PARTY_LEAVE_SUCCESS, "%bw_lang_prefix%&7%bw_player%&e离开了组队！");
        yml.addDefault(Messages.COMMAND_PARTY_DISBAND_SUCCESS, "%bw_lang_prefix%&e组队已解散！");
        yml.addDefault(Messages.COMMAND_PARTY_REMOVE_USAGE, "%bw_lang_prefix%&7用法：&e/party remove <玩家>");
        yml.addDefault(Messages.COMMAND_PARTY_REMOVE_SUCCESS, "%bw_lang_prefix%&7%bw_player%&e被移出了组队。");
        yml.addDefault(Messages.COMMAND_PARTY_REMOVE_DENIED_TARGET_NOT_PARTY_MEMBER, "%bw_lang_prefix%&7%bw_player%&e不在你的组队中！");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_SUCCESS, "%bw_lang_prefix%&e你成功将%bw_player%提升为队长！");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_OWNER, "%bw_lang_prefix%&e你已被提升为队长！");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_NEW_OWNER, "%bw_lang_prefix%&7&e%bw_player% 已被提升为队长！");
        ...
        yml.addDefault(Messages.COMMAND_SHOUT_DISABLE_SOLO, "&c喊话在单挑模式中是被禁用的!");
        yml.addDefault(Messages.COMMAND_LEAVE_STARTED, "&a&l将在%bw_leave_delay%秒后将你传送至大厅... 再次右键点击以取消传送！");
        yml.addDefault(Messages.COMMAND_LEAVE_CANCELED, "&c&l传送已取消！");
        ...
        yml.addDefault(Messages.ARENA_GUI_ARENA_CONTENT_LORE, Arrays.asList("", "&7状态：%bw_arena_status%", "&7玩家数：&f%bw_on%&7/&f%bw_max%", "&7模式：&a%bw_group%", "", "&a点击进入", "&e右击观战"));
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CHAT, "%bw_lang_prefix%&e游戏将在&6%bw_time%&e秒后开始！");
        ...
        yml.addDefault(Messages.ARENA_SPECTATOR_LEAVE_ITEM_LORE, Collections.singletonList("&7右键传送至起床战争大厅！"));
        ...
        yml.addDefault(Messages.GENERATOR_HOLOGRAM_TIMER, "&c%bw_seconds%&e秒后生成");
        ...
        yml.addDefault(Messages.FORMATTING_CHAT_SHOUT, "%bw_level%%bw_v_prefix%&6[喊话] %bw_team_format% &7%bw_player%&f%bw_v_suffix%：%bw_message%");
        ...
        yml.addDefault(Messages.FORMATTING_ACTION_BAR_TRACKING, "&f追踪： %bw_team% &f- 距离： %bw_distance%m");
        yml.addDefault(Messages.FORMATTING_BOSSBAR_DRAGON, "%bw_team%&7的龙");
        ...
        yml.addDefault(Messages.INTERACT_BED_DESTROY_TITLE_ANNOUNCEMENT, "&c床已被破坏！");
        ...
        yml.addDefault(Messages.INTERACT_INVISIBILITY_REMOVED_DAMGE_TAKEN, "&c你因受到伤害而被迫现形！");
        yml.addDefault(Messages.INTERACT_MAGIC_MILK_REMOVED, "&c你的魔法牛奶已失效！");
        ...
        yml.addDefault(Messages.ARENA_MAX_BUILD_LIMIT_REACHED, "&c已到达最高高度限制！");
        yml.addDefault(Messages.ARENA_MIN_BUILD_LIMIT_REACHED, "&c已到达最低高度限制");
        yml.addDefault(Messages.ARENA_FIREBALL_COOLDOWN, "&c请等待%bw_cooldown%秒后再使用！");
        yml.addDefault(Messages.ARENA_IN_GAME_ANNOUNCEMENT, Arrays.asList("&c&l如果你断开连接，可以使用/rejoin重新加入游戏！", "&c&l禁止跨队联合！使用/report举报跨队联合的玩家。"));
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_TITLE, "&c你死了！");
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_SUBTITLE, "&e你将在&c%bw_time%&e秒后重生！");
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_CHAT, "%bw_lang_prefix%&e你将在&c%bw_time%&e秒后重生！");
        ...
        yml.addDefault(Messages.PLAYER_DIE_RESPAWNED_TEXT, "%bw_lang_prefix%&e你已重生！");
        ...
        yml.addDefault(Messages.NEXT_EVENT_BEDS_DESTROY, "&f床自毁");
        yml.addDefault(Messages.NEXT_EVENT_DIAMOND_UPGRADE_II, "&f钻石生成点II级");
        yml.addDefault(Messages.NEXT_EVENT_DIAMOND_UPGRADE_III, "&f钻石生成点III级");
        yml.addDefault(Messages.NEXT_EVENT_DRAGON_SPAWN, "&f绝杀模式");
        yml.addDefault(Messages.NEXT_EVENT_EMERALD_UPGRADE_II, "&f绿宝石生成点II级");
        yml.addDefault(Messages.NEXT_EVENT_EMERALD_UPGRADE_III, "&f绿宝石生成点III级");
        yml.addDefault(Messages.NEXT_EVENT_GAME_END, "&4游戏结束！");
        yml.addDefault(Messages.NEXT_EVENT_TITLE_ANNOUNCE_BEDS_DESTROYED, "&c床已被破坏！");
        ...
        yml.addDefault(Messages.MONEY_REWARD_PER_MINUTE, "%bw_lang_prefix%&6+%bw_money%硬币(游戏时间)");
        yml.addDefault(Messages.MONEY_REWARD_WIN, "%bw_lang_prefix%&6+%bw_money%硬币(游戏胜利)");
        yml.addDefault(Messages.MONEY_REWARD_PER_TEAMMATE, "%bw_lang_prefix%&6+%bw_money%硬币(团队协作)");
        yml.addDefault(Messages.MONEY_REWARD_BED_DESTROYED, "%bw_lang_prefix%&6+%bw_money%硬币(破坏床)");
        yml.addDefault(Messages.MONEY_REWARD_FINAL_KILL, "%bw_lang_prefix%&6+%bw_money%硬币(最终击杀)");
        yml.addDefault(Messages.MONEY_REWARD_REGULAR_KILL, "%bw_lang_prefix%&6+%bw_money%硬币(击杀)");
        ...
        yml.addDefault(Messages.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_LORE.replace("%path%", "leave"), Collections.singletonList("&f右键传送至起床战争大厅！"));
        ...
        yml.addDefault(Messages.SCOREBOARD_LOBBY, Arrays.asList("&6&l起床战争,&4&l起&6&l床战争,&6&l起&4&l床&6&l战争,&6&l起床&4&l战&6&l争,&6&l起床战&4&l争,&6&l起床战争",
                "&f等级：%bw_level%", "", "&f进度：&a%bw_current_xp%&7/&b%bw_required_xp%", "%bw_progress%", "", "&7%bw_player%", "", "&f硬币：&a%bw_money%", "", "&f总胜场：&a%bw_wins%", "&f总击杀：&a%bw_kills%", "", "&e%bw_server_ip%"));

        yml.addDefault(Messages.SHOP_INDEX_NAME, "&8快速购买");
        yml.addDefault(Messages.SHOP_QUICK_ADD_NAME, "&8添加到快速购买...");
        yml.addDefault(Messages.SHOP_INSUFFICIENT_MONEY, "%bw_lang_prefix%&c你没有足够的%bw_currency%！ 还需要%bw_currency%x%bw_amount%！");
        yml.addDefault(Messages.SHOP_NEW_PURCHASE, "%bw_lang_prefix%&a你购买了&6%bw_item%");
        yml.addDefault(Messages.SHOP_ALREADY_BOUGHT, "%bw_lang_prefix%&c你已经购买过了！");
        yml.addDefault(Messages.SHOP_ALREADY_HIGHER_TIER, "%bw_lang_prefix%&c你已经购买了更高阶的物品。");
        ...
        yml.addDefault(Messages.SHOP_QUICK_EMPTY_LORE, Arrays.asList("&7这是一个快速购买槽位！", "&bShift+左键 &7商店中的物品", "&7来添加到这里。"));
        ...
        yml.addDefault(Messages.SHOP_LORE_QUICK_ADD, "&bShift+左键 来添加快速购买");
        yml.addDefault(Messages.SHOP_LORE_QUICK_REMOVE, "&bShift+左键 来从快速购买中移除！");
        ...
        addContentMessages(yml, "stick", ConfigPath.SHOP_PATH_CATEGORY_MELEE, "%bw_color%木棍(击退I)", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "", "%bw_quick_buy%", "%bw_buy_status%"));
        ...
        addContentMessages(yml, "bow2", ConfigPath.SHOP_PATH_CATEGORY_RANGED, "%bw_color%弓（力量I）", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "", "%bw_quick_buy%", "%bw_buy_status%"));
        addContentMessages(yml, "bow3", ConfigPath.SHOP_PATH_CATEGORY_RANGED, "%bw_color%弓（力量I, 冲击I）", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "", "%bw_quick_buy%", "%bw_buy_status%"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "&8药水", "&a药水", Collections.singletonList("&e点击查看！"));

        addContentMessages(yml, "speed-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "%bw_color%速度 II 药水（45秒）", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "", "%bw_quick_buy%", "%bw_buy_status%"));
        addContentMessages(yml, "jump-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "%bw_color%跳跃提升 V 药水（45秒）", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "", "%bw_quick_buy%", "%bw_buy_status%"));
        addContentMessages(yml, "invisibility", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "%bw_color%隐身药水（30秒）", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "", "%bw_quick_buy%", "%bw_buy_status%"));
        ...
        addContentMessages(yml, "dream-defender", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "%bw_color%梦境守卫者", Arrays.asList("&7花费：%bw_cost% %bw_currency%", "",
                "&7召唤铁傀儡来保护基地", "&7持续4分钟", "", "%bw_quick_buy%", "%bw_buy_status%"));
        ...
        addContentMessages(yml, "tower", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "%bw_color%速建防御塔", Arrays.asList("&花费: %bw_cost% %bw_currency%", "",
                "&7放置一个速建防御塔", "&7塔防！", "", "%bw_quick_buy%", "%bw_buy_status%"));
        ...
        yml.addDefault(Messages.UPGRADES_LORE_REPLACEMENT_INSUFFICIENT_SPACE, "&e你的背包空间不足以购买此物品！");
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "armor").replace("%bw_tier%", "tier-1"), "%bw_color%护甲强化I");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("%bw_name%", "armor"),
                Arrays.asList("&7队伍的所有护甲获得保护附魔！", "", "{tier_1_color}等级1：保护I， &b{tier_1_cost} {tier_1_currency}",
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "armor").replace("%bw_tier%", "tier-2"), "%bw_color%装备强化II");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "armor").replace("%bw_tier%", "tier-3"), "%bw_color%装备强化III");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "armor").replace("%bw_tier%", "tier-4"), "%bw_color%装备强化IV");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "miner").replace("%bw_tier%", "tier-1"), "%bw_color%装备强化I");
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "miner").replace("%bw_tier%", "tier-2"), "%bw_color%疯狂矿工II");
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("%bw_name%", "dragon").replace("%bw_tier%", "tier-1"), "%bw_color%龙增益");
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE2_PATH + "first",
                Arrays.asList("", "&7下个购买的陷阱将进入此队列", "&7陷阱的价格将会随着其数量增加", "", "&7下个陷阱花费：&b%bw_cost% %bw_currency%"));
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_ALREADY_CHAT, "&c你已经升级过此增益了！");
        save();
